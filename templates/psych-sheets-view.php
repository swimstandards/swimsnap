...
<p class="mt-4 mb-0 small text-muted">
  <a href="<?= htmlspecialchars($base_url . '/raw-file.php?type=psych-sheets&slug=' . rawurlencode($slug), ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener">View raw file (for debugging)</a>
</p>
